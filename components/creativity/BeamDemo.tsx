...
export default function AnimatedBeamMultipleInputDemo() {
  ...
  return (
    <div
      className="relative flex max-h-[415px] min-h-[415px] w-full max-w-[32rem] items-center justify-center overflow-hidden rounded-lg border bg-#000319 p-10 md:shadow-xl"
      ref={containerRef}
    >
